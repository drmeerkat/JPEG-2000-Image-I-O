...
public class Histogram {
    ...
    public Histogram(String pathname, String title){
        image = getImage(pathname);
        this.title = title;
    }

    public Histogram(BufferedImage ima, String title){
        image = ima;
        this.title = title;
    }
    ...
    private ChartPanel createChartPanel() {
        ...
        // chart
        JFreeChart chart = ChartFactory.createHistogram(this.title, "Value",
    ...
    private ChartPanel createChartPanel(Boolean isGray) {
        // dataset
        dataset = new HistogramDataset();
        Raster raster = image.getRaster();
        final int w = image.getWidth();
    ...
    private JPanel createControlPanel(Boolean isGray) {
        JPanel panel = new JPanel();
        panel.add(new JCheckBox(new VisibleAction(0)));
        return panel;
    }
    ...
    public void display(Boolean isGray) {
        JFrame f = new JFrame(this.title);
        f.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        if (isGray){
            f.add(createChartPanel(isGray));
            f.add(createControlPanel(isGray), BorderLayout.SOUTH);
        }
        else{
